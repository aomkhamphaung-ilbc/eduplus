                ...
                <div class="row">
                    <div class="col-md-12 mb-4">
                        <div class="md-form md-outline input-with-post-icon datepicker" id="prefill">
                            <label for="prefill-example">Description</label>
                            <input placeholder="Enter description" type="text" name="description"
                                id="prefill-example" class="form-control" required>
                    ...
                    <div class="col-md-12 mb-4">
                        <div class="md-form md-outline input-with-post-icon datepicker" id="prefill">
                            <label for="prefill-example">Start Time...</label>
                            <input placeholder="Select date" type="datetime-local" name="start_time"
                                id="prefill-example" class="form-control" required>
                            <i class="fas fa-calendar input-prefix" tabindex=0></i>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 mb-4">
                        <div class="md-form md-outline input-with-post-icon datepicker" id="prefill">
                            <label for="prefill-example">End Time...</label>
                            <input placeholder="Select date" type="datetime-local" name="end_time" id="prefill-example"
